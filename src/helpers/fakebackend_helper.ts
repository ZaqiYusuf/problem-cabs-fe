...
// Mailbox
export const getMail = () => api.get(url.GET_MAIL);
...
// Calendar
export const getEvents = () => api.get(url.GET_EVENT);
...
// Grid View
export const getProductGrid = () => api.get(url.GET_PRODUCT_GRID);
...
// Overview
export const getReview = () => api.get(url.GET_REVIEW);
...
// Holidays
export const getHolidays = () => api.get(url.GET_HOLIDAYS);
...
export const getLeaveManageEmployee = () => api.get(url.GET_LEAVE_MANAGE_EMPLOYEE);

// Leave Manage (HR)
export const getLeaveManageHR = () => api.get(url.GET_LEAVE_MANAGE_HR);
...
// Attendance
// Attendance (HR)
export const getAttendance = () => api.get(url.GET_ATTENDANCE);

// Main Attendance
export const getMainAttendance = () => api.get(url.GET_MAIN_ATTENDANCE);
...
// Sales
// Estimates
export const getEstimates = () => api.get(url.GET_ESTIMATES);
...
// Payments
export const getPayments = () => api.get(url.GET_PAYMENTS);
...
// Payroll
// Employee Salary
export const getEmployeeSalary = () => api.get(url.GET_EMPLOYEE_SALARY);
...
// Notes
export const getNotes = () => api.get(url.GET_NOTES);
...
// Social
// Friends
export const getSocialFriends = () => api.get(url.GET_SOCIAL_FRIENDS);

// Events
export const getSocialEvent = () => api.get(url.GET_SOCIAL_EVENTS);
...
// Grid View
export const getUserGrid = () => api.get(url.GET_USER_GRID);
