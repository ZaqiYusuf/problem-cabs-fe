...
import { CategoriesData } from "Common/data/dashboard";
...
const Table = () => {
  ...
  const filterSearchData = (e: any) => {
    ...
    const keysToSearch = ["item"];
    filterDataBySearch(CategoriesData, search, keysToSearch, setData);
  };
        ...
        <div className="card-body">
          <div className="grid items-center grid-cols-1 gap-3 mb-5 xl:grid-cols-12">
            <div className="xl:col-span-3">
              <h6 className="text-15">List Categories</h6>
            </div>
