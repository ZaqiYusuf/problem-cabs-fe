...
import { NameTenantData } from "Common/data/dashboard";

const Table = () => {
  const [data, setData] = useState(NameTenantData);

  // Search Data
  const filterSearchData = (e: any) => {
    const search = e.target.value;
    const keysToSearch = ["name"];
    filterDataBySearch(NameTenantData, search, keysToSearch, setData);
  };
        ...
        <div className="card-body">
          <div className="grid items-center grid-cols-1 gap-3 mb-5 xl:grid-cols-12">
            <div className="xl:col-span-3">
              <h6 className="text-15">Tenant List</h6>
            </div>
